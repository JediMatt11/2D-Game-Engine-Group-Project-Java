...
public class SpriteBorder extends TreeSet<BorderPoint>
{
    ...
    private static BufferedImage generateScaledImage( Image originalImage, int width, int height)
    {
                                                ...
                                                int scaleHeight)
    {
        ...
        BufferedImage scaledImage = generateScaledImage(image, scaleWidth, scaleHeight);
